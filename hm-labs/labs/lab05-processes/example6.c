...
//STDERR_FILENO = 2
//
//pipe fd[0](for reading) = 3
//pipe fd[1](for writing) = 4
//
//child copy of pipe fd[0] = 3
//child copy of pipe fd[1] = 4
//
//======= In parent process =====
//hello msg from child sent and buffered in pipe
//hello from child from exec
